...
\usepackage{lmodern, beamermotto, columnshort}
...
\useinnertheme{NMTRIL}
\useoutertheme[subsection = false]{NMTRIL}
\usecolortheme{NMTRIL}

%% If you don't want a motto, leave the area between the curly braces blank
\motto{\color{RILred}\textrm{\emph{``Add a cool motto or quote or whatever'' -- DCP}}}
